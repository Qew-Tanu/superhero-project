        ...
        <div className='flex w-fit'>
            <div className='flex flex-wrap gap-5 h-[100%] justify-center m-auto w-fit'>
                {props.item.map((item) => {
                    ...
                    return (
                        <Link to={`/${text}`} className='flex flex-col justify-self-start justify-between p-1 sm:p-3 text-[0.6rem] sm:text-[0.75rem] lg:text-[1rem] bg-[#7a7a7acc] w-[150px] h-[300px] sm:w-[200px] rounded-[30px] text-white ' key={item.id}>
