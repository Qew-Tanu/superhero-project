                    ...
                    {props.item.map((item, index) => {
                        ...
                        return (
                            <SwiperSlide key={index} className=' h-[calc(100%-30px)] bg-[#7a7a7acc] rounded-[15px] lg:rounded-[30px]'>
                                <Link reloadDocument to={`/detail?type=${props.type}&id=${item.id}`} className='flex flex-col justify-between h-full p-1 sm:p-3 text-[0.6rem] sm:text-[0.75rem] lg:text-[1rem] text-white '>
